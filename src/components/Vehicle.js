    ...
    <>
      ...
      <div className={styles.vehicle__input}>
        <input 
          ...
          onChange={(e) => 
            dispatch(editVehicle({ ...editedVehicle, vehicle_name: e.target.value }))
          }
        />
        <input 
          type="number"
          ...
          onChange={(e) => 
            dispatch(editVehicle({...editedVehicle, release_year: e.target.value,}))
          }
        />
        <input 
          type="number"
        ...
        {vehicles.map((vehicle) => (
          <li className={styles.vehicle__item} key={vehicle.id}>
            <span data-testid={`list-${vehicle.id}`}>
              ...
              --{vehicle.release_year}--- ¥{vehicle.price} [M] ---{vehicle.segment_name} {vehicle.brand_name}---
            </span>
            <div>
              <button
